<x-app-layout title="Edit Data Kelas">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="border-b border-gray-200 pb-4 mb-6">
            <h2 class="text-xl font-bold text-gray-900">Edit Data Kelas</h2>
            <p class="text-sm text-gray-500">{{ $class->full_name }}</p>
        </div>
                            ...
                            <div>
                                ...
                                <select name="major" id="major" class="form-select mt-1 block w-full" required>
                                    ...
                                    @foreach($majors as $key => $value)
                                        <option value="{{ $key }}" {{ old('major', $class->major) == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="teacher_name" id="teacher_name" value="{{ old('teacher_name', $class->teacher_name) }}" 
                                    class="form-input mt-1 block w-full" required>
                                @error('teacher_name')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="max_students" id="max_students" value="{{ old('max_students', $class->max_students) }}" 
