...
<body class="bg-gray-100">
    <div class="max-w-2xl mx-auto bg-white shadow-md my-8 p-8">
        <div class="text-center border-b-2 border-black pb-4 mb-6">
            <img src="{{ asset('logo.png') }}" alt="Logo Sekolah" class="mx-auto mb-2 w-20 h-20 object-contain">
            <div class="text-2xl font-bold">SMK AL-ISLAH</div>
            <div class="text-sm">Jl. Al-Ishlah No.02-03, Jombang Wetan, Kec. Jombang, Kota Cilegon, Banten 42411</div>
            <div class="text-sm">Telp: 0877-5184-1340 | Email: alislah.co.id</div>
        </div>
        ...
        <table class="w-full border-collapse border border-gray-300 mb-6">
            ...
            <tr>
                ...
                <td class="p-2 border border-gray-300">
                    {{ \Carbon\Carbon::parse($payment->month)->translatedFormat('F Y') }}</td>
            </tr>
            <tr>
        ...
        <div class="text-center mt-8 print:hidden">
            <button onclick="window.print()" class="bg-blue-600 text-white px-4 py-2 rounded mr-2">Cetak
                Kwitansi</button>
