            ...
            <form action="{{ route('payments.index') }}" method="GET">
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="w-full md:w-3/12">
                        ...
                        <select id="class_id" name="class_id" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="w-full md:w-3/12">
                        ...
                        <select id="academic_year" name="academic_year" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="w-full md:w-3/12">
                        ...
                        <select id="payment_status" name="payment_status" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status SPP</th>
